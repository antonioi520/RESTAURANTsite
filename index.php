...
<section id="middleImages">
    <div class="wrapper">
        <div class="row">
            <div class="col-lg-6">
                <div style="margin: auto;width: 50%;position: absolute;z-index: 1;left:25%;top:20%; overflow: hidden;">
                    <img src="img/imgheader3.png" style="object-fit: contain; overflow: hidden">
                ...
                <img class="testy" src="img/FoodDrink/MiAlmaCafe-3.jpg" alt="food" style="height:43.750em;width: 62.500em;object-fit: cover;filter:brightness(30%);float:left; overflow: hidden;">
            </div>
            <div class="col-lg-6">
                <div style="margin: auto;width: 50%;position: absolute;z-index: 1;left:25%;top:20%; overflow: hidden;">
                    <img src="img/imgheader3.png" style="object-fit: contain; overflow: hidden;" >
                ...
                <img class="testy" src="img/Interior/MiAlmaCafeOpeningCeremony-27.jpg" alt="" style="height:43.750em;width: 62.500em;object-fit: cover;filter:brightness(30%);overflow: hidden;">
            </div>
        </iv>
    </div>
</section>
